...
export const getBooking = asyncHandler(async (req: Request, res: Response) => {
  ApiResponse.success(res, await svc.getBooking(req.params.id, req.user!.id, req.user!.role));
});
export const cancelBooking = asyncHandler(async (req: Request, res: Response) => {
  await svc.cancelBooking(req.params.id, req.user!.id, req.user!.role, req.body.reason);
...
export const updateStatus = asyncHandler(async (req: Request, res: Response) => {
  ApiResponse.success(res, await svc.updateStatus(req.params.id, req.body.status, req.body.reason), "Status updated");
});
export const createCheckout = asyncHandler(async (req: Request, res: Response) => {
  ApiResponse.success(res, await svc.createCheckout(req.params.id, req.user!.id));
});
